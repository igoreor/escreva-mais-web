...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-button-1 text-button-1 hover:bg-blue-700 active:bg-blue-800 focus:ring-blue-500',
    secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
    outline: 'border-[3px] border-solid border-global-2 text-global-2 bg-global-3 hover:bg-blue-50 active:bg-blue-100 focus:ring-blue-300',
  ...
  const sizes = {
    ...
    xl: 'px-6 py-3 text-lg sm:px-7 sm:py-4 sm:text-xl md:text-xl lg:text-2xl'
  };
