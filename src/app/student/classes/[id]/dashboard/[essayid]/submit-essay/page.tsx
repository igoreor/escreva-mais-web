...
import { FiHome, FiUpload, FiFileText, FiUser, FiPaperclip, FiBookOpen, FiArrowLeft, FiTrello } from "react-icons/fi";
    ...
    <RouteGuard allowedRoles={["student"]}>
      <div className="flex min-h-screen bg-global-2">
        ...
        <div className="ml-64 flex flex-col flex-1 px-8 sm:px-12 md:px-16 py-10 sm:py-12 md:py-16 overflow-y-auto">
                      <button
            onClick={() => window.location.href = `/student/classes/${classId}/dashboard/${params.essayid}`}
