        ...
        <main className="ml-0 lg:ml-[270px] w-full max-h-screen overflow-y-auto p-6 lg:p-12">
          <div className="mx-auto w-full max-w-5xl space-y-6">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 lg:p-8 space-y-6">
              {/* Título */}
              <div>
                <label className="text-sm font-medium text-gray-600 block mb-2">Título (opcional)</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                <div>
                  <label className="text-sm font-medium text-gray-600 block mb-1">Data de envio</label>
                  <p className="text-gray-800">
                    {essay.created_at ? new Date(essay.created_at).toLocaleDateString('pt-BR') : 'Não disponível'}
                  </p>
                </div>
                <div>
